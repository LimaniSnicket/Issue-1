...
public class TestPlayer : MonoBehaviour {
	...
	void Update () {
		...
		if (gamePaused == false) {
			...
			if (playerMana < 20) {
				playerMana = playerMana + 1.3f * Time.deltaTime; //player mana regeneration!!!!
			} 
